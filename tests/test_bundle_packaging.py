...
assert.strictEqual(migrated.pi.experience_timeout_enabled, false);
assert.strictEqual(migrated.pi.experience_call_timeout_seconds, 600);
assert.strictEqual(migrated.pi.experience_extraction_chunk_chars, 100000);
assert.strictEqual(migrated.pi.experience_structure_max_chars, 250000);
assert.strictEqual(migrated.pi.experience_cross_link_max_calls, 8);
assert.strictEqual(migrated.pi.experience_coverage_audit, true);
assert.strictEqual(migrated.pi.experience_json_repair_attempts, 1);
...
(async()=>{
  ...
  assert.strictEqual(result.config.pi.experience_timeout_enabled, false);
  assert.strictEqual(result.config.pi.experience_call_timeout_seconds, 600);
  assert.strictEqual(result.config.pi.experience_extraction_chunk_chars, 100000);
  assert.strictEqual(result.config.pi.experience_structure_max_chars, 250000);
  assert.strictEqual(result.config.pi.experience_cross_link_max_calls, 8);
  assert.strictEqual(result.config.pi.experience_coverage_audit, true);
  assert.strictEqual(result.config.pi.experience_json_repair_attempts, 1);
